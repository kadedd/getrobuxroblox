...
(function( $ )
	...
	var Platforms =["<span class='platfrom-append'>on</span> iOS","<span class='platfrom-append'>on</span> iOS","<span class='platfrom-append'>on</span> PC","<span class='platfrom-append'>on</span> PS4","<span class='platfrom-append'>on</span> iOS"];
	var FUTresources =["<span class='activity-vbucks'>10,000 Robux</span>","<span class='activity-vbucks'>1,700 Robux</span>","<span class='activity-vbucks'>22,500 Robux</span>","<span class='activity-vbucks'>4,500 Robux</span>", "<span class='activity-vbucks'>10,000 Robux</span>", "<span class='activity-vbucks'>22,500 Robux</span>", "<span class='activity-vbucks'>4,500 Robux</span>", "<span class='activity-vbucks'>1,700 Robux</span>", "<span class='activity-vbucks'>22,500 Robux</span>", "<span class='activity-vbucks'>4,500 Robux</span>", "<span class='activity-vbucks'>10,000 Robux</span>", "<span class='activity-vbucks'>4,500 Robux</span>"];
	$(document).ready(function() {
...
$('.generate').click(function(event) {
		if ($('.username-connected').hasClass('connected')) {
			...
			progress_snap(function() {
						...
						$('#fortnite-progress-text').text('Generate Robux Package');
